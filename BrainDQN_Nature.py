...
class BrainDQN:
    def __init__(self,actions):
        ...
        checkpoint = tf.train.get_checkpoint_state("saved_wb")
    ...
    def createQNetwork(self):
        ...
        print('********',h_conv1,h_pool1,h_conv2,h_conv3,h_conv3_flat,h_fc1,QValue)
        self.saver_wb = tf.train.Saver({'W_conv1': W_conv1, 'W_conv2':W_conv2,'W_conv3':W_conv3,'W_fc1':W_fc1,'W_fc2':W_fc2,
    ...
    def trainQNetwork(self):
        ...
        if self.timeStep % 10000 == 0:
            ...
            self.saver_wb.save(self.session,'saved_wb/'+'network'+'-dqn',global_step=self.timeStep)
    ...
    def setPerception(self,nextObservation,action,reward,terminal):
        #newState = np.append(nextObservation,sel   ASWEDRFTGYHUJIKLf.currentState[:,:,1:],axis = 2)
        #此处说明输入的是连续的四帧图片
    ...
    def getAction(self):
        QValue = self.QValue.eval(feed_dict= {self.stateInput:[self.currentState]})[0]#因为在网络的设置中 QValue是二维的
